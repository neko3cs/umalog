...
struct CSVExporterTests {
    ...
    @Test @MainActor func export_raceRow_containsDate() throws {
    ...
    @Test @MainActor func export_raceRow_containsRaceNumber() throws {
        let container = try makeContainer()
    ...
    @Test @MainActor func export_raceRow_turfTrackType() throws {
        let container = try makeContainer()
    ...
    @Test @MainActor func export_raceRow_dirtTrackType() throws {
        let container = try makeContainer()
    ...
    @Test @MainActor func export_raceRow_centralCategory() throws {
        let container = try makeContainer()
    ...
    @Test @MainActor func export_raceRow_localCategory() throws {
        let container = try makeContainer()
    ...
    @Test @MainActor func export_raceRow_containsTotalPurchase() throws {
        let container = try makeContainer()
    ...
    @Test @MainActor func export_raceRow_containsTotalPayout() throws {
        let container = try makeContainer()
        let ctx = container.mainContext
        let race = Race(); ctx.insert(race)
    ...
    @Test @MainActor func export_raceRow_containsBalance() throws {
        let container = try makeContainer()
        let ctx = container.mainContext
        let race = Race(); ctx.insert(race)
    ...
    @Test @MainActor func export_entryRow_containsHorseName() throws {
        let container = try makeContainer()
        let ctx = container.mainContext
        let race = Race(); ctx.insert(race)
    ...
    @Test @MainActor func export_entryRow_containsHorseNumber() throws {
        let container = try makeContainer()
        let ctx = container.mainContext
        let race = Race(); ctx.insert(race)
    ...
    @Test @MainActor func export_entryRow_containsPredictionMark() throws {
        let container = try makeContainer()
        let ctx = container.mainContext
        let race = Race(); ctx.insert(race)
    ...
    @Test @MainActor func export_entryRow_withNoPredictionMark_includesHorseName() throws {
        let container = try makeContainer()
        let ctx = container.mainContext
        let race = Race(); ctx.insert(race)
    ...
    @Test @MainActor func export_betRow_containsTicketTypeAndSelection() throws {
        let container = try makeContainer()
        let ctx = container.mainContext
        let race = Race(); ctx.insert(race)
    ...
    @Test @MainActor func export_betRow_containsPurchaseAndPayout() throws {
        let container = try makeContainer()
        let ctx = container.mainContext
        let race = Race(); ctx.insert(race)
    ...
    @Test @MainActor func export_valueWithComma_isQuoted() throws {
        let container = try makeContainer()
    ...
    @Test @MainActor func export_valueWithDoubleQuote_isEscaped() throws {
        let container = try makeContainer()
    ...
    @Test @MainActor func export_normalValue_isNotQuoted() throws {
        let container = try makeContainer()
    ...
    @Test @MainActor func export_memoWithNewline_isReplacedWithSpace() throws {
        let container = try makeContainer()
    ...
    @Test @MainActor func export_racesAreSortedByDateAscending() throws {
        let container = try makeContainer()
        let ctx = container.mainContext
        let today = Date()
